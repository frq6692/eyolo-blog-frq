...
const PostThree = ({ post, text = "light" }: Props) => {
  return (
    <article className="post-card post-category-top group relative has-line-link">
      <PostThumbnail post={post} text={text} />

      <div className="mt-6 text-center">
        <span className="text-sm flex justify-center gap-2 items-center mb-3 uppercase">
          {/* prettier-ignore */}
        ...
        <ul className="flex flex-wrap items-center justify-center gap-3 gap-y-1 mb-6 uppercase text-sm text-[#464536]">
