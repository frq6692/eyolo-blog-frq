...
const Banner = ({ trendingPosts, banner }: Props) => {
  return (
    <>
      <section
      ...
      <section className="pb-16 sm:pb-24 overflow-clip relative z-50">
        ...
        <div className="absolute w-[1920px] h-[728px] left-1/2 -translate-x-1/2 bottom-0 pointer-events-none">
          <svg className="text-secondary/25 w-full absolute bottom-0 pointer-events-none -z-10" width="1920" height="728" viewBox="0 0 1920 728" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M0 0C953.5 380.5 1009 380.5 1920 0V803.5H0V0Z" fill="currentColor"/></svg>
          
          {/* fix svg background for large devices */}
          {/* <div className="absolute w-full h-full z-10 after:content-[''] after:bg-secondary/25 after:absolute after:h-full after:w-full after:left-full after:bottom-0 after:-z-10 before:content-[''] before:bg-secondary before:absolute before:h-full before:w-full before:-left-full before:bottom-0 before:-z-10"></div> */}
        </div>
