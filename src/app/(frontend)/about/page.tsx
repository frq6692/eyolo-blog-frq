...
const About = async () => {
  const { banner, about_info, authors } = aboutData.frontmatter;
        ...
        <section className="pb-16 sm:pb-24 bg-light">
          ...
          <div className="container">
            <div className="row gy-5 mt-14">
              {users?.map((author) => (
                <div key={author.id} className="sm:col-6 lg:col-3">
                  <Link
                  ...
                  >
                    <Image
                      ...
                      src="/images/author/kathryn-jackson.jpg"
                      alt={author.name}
                      height={200}
                      width={200}
                    />
